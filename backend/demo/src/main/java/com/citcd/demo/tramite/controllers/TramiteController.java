...
public class TramiteController {
	...
	public ResponseEntity<Void> createTramite(@Valid @RequestBody TramiteRequestDTO newTramiteRequest,
		...
		URI locationOfNewCashCard = ucb.path("/api/tramites/{id}").buildAndExpand(savedTramite.getId()).toUri();

		return ResponseEntity.created(locationOfNewCashCard).build();
	}

	@PutMapping("/{id}/asignar")
	public ResponseEntity<Void> asignarFuncionarioTramite(@PathVariable("id") Long requestedId,
	...
	public ResponseEntity<Void> actualizarEstadoTramite(@PathVariable("id") Long requestedId,
	...
	public ResponseEntity<Void> agregarComentarioTramite(@PathVariable("id") Long requestedId,
	...
	public List<TramiteResponseDTO> findTramiteByFuncionarioId(@PathVariable("id") Long requestedId) {
		return service.findTramiteByFuncionarioId(requestedId);
	}

	@GetMapping("/{id}/seguimiento")
	public List<SeguimientoResponseDTO> findSeguimientoByTramiteId(@PathVariable("id") Long requestedId) {
		return service.findSeguimientoByTramiteId(requestedId);
	}
